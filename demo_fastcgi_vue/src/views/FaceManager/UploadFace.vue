    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>添加人脸</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <div class="crop-demo">
                ...
                <div v-if="showFlag">
                    <el-button style="margin-left: 30px" size="small" type="success" @click="submitUpload">点击上传</el-button>
                </div>
            </div>
    ...
    methods: {
        ...
        submitAxious() {
            ...
            this.$axios
                ...
                .then((res) => {
                    ...
                    if (res.data.error_code === 223105) {
                        this.$message.error(`已存在存在人脸,无需重新上传`);
                        that.cropImg = that.defaultSrc;
                    }
                    if (res.data === '') {
                        this.$message.error(`上传失败,上传时请确认网络连接正常`);
                        that.cropImg = that.defaultSrc;
                    }
                })
                .catch((err) => {
        ...
        submitUpload() {
            ...
            if (this.$store.getters.getUser.roseID === '2') {
                ...
                console.log(this.ruleForm.userID,this.$store.getters.getUser.userID);
