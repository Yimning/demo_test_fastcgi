    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="success" icon="el-icon-circle-plus" @click="handleAdd">添加教师人脸</el-button>
                <el-button type="info" icon="el-icon-download" @click="handleUpload">更新教师人脸</el-button>
            </div>
            <el-table
                :data="tableData"
                border
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    ...
                    console.log(id);
                    this.$axios
                        .post('/api/teacher/deleteOneFace/' + id)
                        .then((res) => {
                            //console.log(res);
            ...
            if (length == 0) {
                ...
                this.$confirm('此操作将批量删除日志信息, 是否继续?', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$axios.post('/api/teacher/deleteMoreFace', { teacherNumber: str }).then((res) => {
