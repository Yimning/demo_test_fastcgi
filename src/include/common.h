...
#define DEBUG_PATH ("/home/yimning/FastCGI/lighttpd/www/demo_test_fastcgi/src/debug/debug.txt")
#define LOGIN_PATH ("/home/yimning/FastCGI/lighttpd/www/demo_test_fastcgi/src/debug/login")
